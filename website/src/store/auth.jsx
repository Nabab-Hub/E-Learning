...
export const AuthProvider = ({children}) => {
    ...
    const PYTHON_BACKEND_HOSTING_URL = 'https://informed-choice-wahoo.ngrok-free.app'
    ...
    return <AuthContext.Provider value={{storeTokenInLS, LogoutUser, isLoggedIn, BACKEND_HOSTING_URL, PYTHON_BACKEND_HOSTING_URL, user, authorizationToken}}>
        {children}
